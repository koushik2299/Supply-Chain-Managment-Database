...
--
-- Table structure for table `inventorylocations`
--
...
--
-- Table structure for table `productactualprices`
--

DROP TABLE IF EXISTS `productactualprices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `productactualprices` (
  `PID` int NOT NULL,
  `ACTUAL_PRICE` decimal(10,2) DEFAULT NULL,
  `EFFECTIVE_DATE` date NOT NULL,
  PRIMARY KEY (`PID`,`EFFECTIVE_DATE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-02 10:30:52
